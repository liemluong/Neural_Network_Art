...
PATH = 'django_ec2_project\\django_ec2_project'
data_folder_dir = os.path.join(PATH, 'static')
object_input_dir = os.path.join(data_folder_dir, 'items')
style_input_dir = os.path.join(data_folder_dir, 'patterns')
image_output_dir = os.path.join(data_folder_dir, 'outputs')

# User selects object and style from the web
# The two images are loaded into the model
selected_object_image = 'dress.png'
selected_style_image = 'dots.jpg'
